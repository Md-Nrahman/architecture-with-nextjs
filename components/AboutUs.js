...
const AboutUs = () => {
  return (
    <div>
        ...
        <h1 className='text-center text-2xl md:text-4xl font-semibold text pb-6 pt-6 text-gray-600'>Welcome to <span className='text-indigo-600'>ARCHI</span></h1>
...
Mauris semper varius ex eu porta. </h3>
        ...
        <div className='hidden lg:block absolute z-0 right-[-70px] top-1/2 rotate-90 text-7xl text-gray-300 font-medium'><h1>About Us</h1></div>
        </div>
    </div>
  )
}
